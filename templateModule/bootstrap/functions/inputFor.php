...
class FuncInputFor extends \lib\template\AbstractFunction
{
    ...
    {
        return $this->template->parseFile("bootstrap/inputFor",array_merge($data,array("_field"=>$parameters[0],"_type"=>$parameters[1],"_source"=>isset($parameters[2])?$parameters[2]:array())));
    }
